...
drawDots = function() {
    ...
    let amountX = 50;
    let amountY = 50;
    let t = (frameCount + 10000000000) * 0.025 * 0.0001;
    let a = 0.00005;
    let i = 0;
...
//             let dy = abs(sin(y) * 0.1 - Math.tan(t * 0.0025));
            ...
            let m = 4e3 + tt;
            let xx = x + (Math.pow(Math.tan((m + x * 100) * 1000) * Math.sin(t * y * 1e-3), 50)) * 100;
            let yy = y + (Math.pow(Math.tan((m + y * 100) * 1000) * Math.sin(t * x * 1e-3), 50)) * 100;
