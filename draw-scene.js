...
drawDots = function() {
    ...
    for (let x = 0; x < 100; x += 1) {
        for (let y = 0; y < 100; y += 1) {
            let ox = (x - 50) * sin(t * a);
            let oy = (y - 50) * cos(t * a);
            let xx = x + cos(ox * oy * 100) * cos(ox * 0.125) + cos(ox * oy * a + t) * 4;
            let yy = y + cos(ox * oy * 100) * sin(ox * 0.125) + sin(ox * oy * a + t) * 4;
            vertices.push(xx * 0.015 - 0.75, yy * 0.015 - 0.75, 0.0);
        }
    }
